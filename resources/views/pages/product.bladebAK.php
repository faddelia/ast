					...
					<div class="row">
						<div class="col">
							...
							<h4 class="bread-crumbs">
								<a href="/products">Products</a> >> {{ $product->product_name }}
							</h4>
						</div>
					</div>
				</div>
								...
								<div class="containter">
									...
									<div class="row">
										<div class="col spec-download">
											Download PDF Specification Sheet >> <a href="{{ Voyager::image($download_link) }}"><img src="{{ URL::to('/') }}/images/pdf_symbol.jpg" title="{{ $original_name }}" alt="{{ $original_name }}"></a>
										</div>
									</div>
								</div>
							</div>
